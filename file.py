...
def tahun(fx):
	if len(fx)==15:
		if fx[:10] in ['1000000000']       :legend = '2009'
		elif fx[:9] in ['100000000']       :legend = '2009'
		elif fx[:8] in ['10000000']        :legend = '2009'
		elif fx[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:legend = '2009'
		elif fx[:7] in ['1000006','1000007','1000008','1000009']:legend = '2010'
		elif fx[:6] in ['100001']          :legend = '2010-2011'
		elif fx[:6] in ['100002','100003'] :legend = '2011-2012'
		elif fx[:6] in ['100004']          :legend = '2012-2013'
		elif fx[:6] in ['100005','100006'] :legend = '2013-2014'
		elif fx[:6] in ['100007','100008'] :legend = '2014-2015'
		elif fx[:6] in ['100009']          :legend = '2015'
		elif fx[:5] in ['10001']           :legend = '2015-2016'
		elif fx[:5] in ['10002']           :legend = '2016-2017'
		elif fx[:5] in ['10003']           :legend = '2018'
		elif fx[:5] in ['10004']           :legend = '2019'
		elif fx[:5] in ['10005']           :legend = '2020'
		elif fx[:5] in ['10006','10007','10008','10009','100010','100011','100012']:legend = '2021-2022'
		else:legend=''
	elif len(fx) in [9,10]:
		legend = '2008-2009'
	elif len(fx)==8:
...
def menu():
	...
	print(f'\x1b[1;92m(1)FILE CLONE')
...
def passwrd():
	...
	print(" \033[97;1mIP ADDRES : \033[38;5;46m"+ip)
...
def crack(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r{x}[{H} CRACKING {x}]{loop}{U}|{H}{ok}"),
	sys.stdout.flush()
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 10; moto g(8) play Build/QMDS30.47-33-5; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.77 Mobile Safari/537.36'
...
def cek_opsi():
	...
	for kes in akun:
		try:
			...
			ua = 'Mozilla/5.0 (Linux; Android 10; moto g (7)power Build/QPOS30.52-29-7-6; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.227 Mobile Safari/537.36'
			ses = requests.Session()
